...
import com.samples.horseracing.feature.history.navigation.HistoryRoute
import com.samples.horseracing.feature.races.navigation.RacesRoute
import kotlin.reflect.KClass
import com.samples.horseracing.feature.history.R as historyR
import com.samples.horseracing.feature.races.R as racesR
...
enum class TopLevelDestination(
    ...
    RACES(
        selectedIcon = HorseRacingIcons.Races,
        unselectedIcon = HorseRacingIcons.RacesBorder,
        iconTextId = racesR.string.feature_races_title,
        titleTextId = R.string.app_name,
        route = RacesRoute::class,
    ),
    HISTORY(
        selectedIcon = HorseRacingIcons.History,
        unselectedIcon = HorseRacingIcons.HistoryBorder,
